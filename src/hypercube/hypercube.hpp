...
private:
    ...
    distance_f dist_func;     // Distance metric 
...
public:
    ...
    hypercube(Dataset &dataset, distance_f dist_func, uint32_t k=14, uint32_t M=10, uint32_t probes=2, uint32_t N=1, uint32_t R=10000);
